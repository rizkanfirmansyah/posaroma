					...
					<div class="col-lg-8">
						<div class="checkbox">
							<label style="color: #0938f7">
								<input id="newclient" name="newclient" class="uniform" type="checkbox" onClick="loadHTMLPost2('app/cashier_ajax.php','new_client','getclient','newclient')"  checked value="1"><b><?php if($_SESSION['bahasa']==1) { echo 'New Customer'; } else { echo 'Customer Baru'; } ?></b>
							</label>
						</div>
					...
					<div class="col-lg-8">
						<div class="checkbox">
							<label style="color: #ff0000">
								<input id="newclient" name="newclient" class="uniform" type="checkbox" onClick="loadHTMLPost2('app/cashier_ajax.php','new_client','getclient','newclient')" value="0" ><b><?php if($_SESSION['bahasa']==1) { echo 'New Customer'; } else { echo 'Customer Baru'; } ?></b>
							</label>
						</div>
...
<?php	
	...
	case "get_nobon":
		...
		$sqlstr 	= 	"select ref2 from sales_invoice where ref2='$ref2' and ref <> '$old_ref' and left(ref,3)='CSR' limit 1";
		...
		if($getref2 != "") {
?>					
			<input type="text" id="ref2" name="ref2" autocomplete="off" class="form-control" onblur="loadHTMLPost3('app/cashier_ajax.php','no_bon','get_nobon','old_ref','ref2')" value=""><font color="#FF0000" size="-1">&nbsp; No Bon sudah dipakai !</font>

<?php
		} else {
?>
			<input type="text" id="ref2" name="ref2" autocomplete="off" class="form-control" onblur="loadHTMLPost3('app/cashier_ajax.php','no_bon','get_nobon','old_ref','ref2')" value="<?php echo $ref2 ?>">
<?php
		}
