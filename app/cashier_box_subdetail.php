...
<script>
	...
	function detailvalue(id, jmldata, ketik){
		...
		var amount = 0;
		amount = parseFloat(qty) * parseFloat(unit_price);
	...
	function detailvalue2(ketik){		
		...
		$('#amount_det').html('<input type="text" onkeyup="formatangka(\'amount\')" id="amount" name="amount" value="'+amount+'" readonly style="text-align:right;" class="form-control" >');
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("exec/cashier_box_detail_insert.php"); 
				
				
				$date = date("d-m-Y");
				/*$sqlclient = $select->list_sales_invoice_detail($ref2);
				$row_client = $sqlclient->fetch(PDO::FETCH_OBJ);
				$item_name = $row_client->name;*/
                                        				
				if ($ref != "") {
					/*$sql=$select->list_sales_invoice_subdetail($ref, $line);
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="cashier_box_detail" id="cashier_box_detail" enctype="multipart/form-data" >
				
				<script langauge="javascript">
			    	function post_refresh(){
			        	
			        	//document.URL = "http://localhost/erparomapos/main.php?menu=app&act=8bbd9d0ff8f82e72fc95a60e7f8524d2&search=CSB-0121-00006";
			        	//window.location = 'main.php?menu=app&act=8bbd9d0ff8f82e72fc95a60e7f8524d2&search=CSB-0121-00006';
			        	var vlocation = '<meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('cashier_box') ?>" />';
			        	alert(vlocation)
			        	self.close();
			    	}
			    </script>
            	...
            	<input type="hidden" id="line_detail" name="line_detail" value="<?php echo $line_detail; ?>" >
				...
				<?php
            		...
            		include("cashier_box_subdetail_update.php");	
