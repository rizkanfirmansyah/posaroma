<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('cashier_box_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/cashier_box_view_xls.php?cashier="+cashier+"&receipt_type_pos="+receipt_type_pos+"&from_date="+date_from+"&to_date="+date_to+"&void="+void_; //+"&all="+all	
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_cashier_box($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('cashier_box_view') ?>" />
			<?php
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									...
									if ($row_cashier->status == "I") {
										$status = "Paid in Part";
									}
									if ($row_cashier->status == "F") {
										$status = "Paid in Full";
									}
									if ($row_cashier->status == "V") {
										$status = "Void";
									}
									if ($row_cashier->status == "S") {
										$status = "Shipped in Part";
									}
									if ($row_cashier->status == "E") {
										$status = "Shipped in Full";
									}
									if ($row_cashier->status == "C") {
										$status = "Closed";
									}
								...
								?>
                                        ...
                                        <tr>
						                    ...
						                    <td><?php echo $row_cashier->date ?></td>
                                            ...
                                            <td align="center">
                                                ...
                                                <?php if (allowupd('frmcashier_box_pos')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('cashier_box') ?>&search=<?php echo $row_cashier->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
