...
?>		
		<!--<tr style="background-color:ffffff;" id="item_ajax2_<?php echo $no; ?>" > -->
			...
			<td align="left">
				<input type="text" id="item_code2" name="item_code2" style="font-size: 12px; width: 272px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onchange="loadHTMLPost3('app/cashier_detail_ajax.php','item_ajax','getdata','item_code2','location_id2')" value="<?php echo $kode ?>" >
			</td>
...
?>		
			...
			<td align="left">
				<input type="text" id="item_code2" name="item_code2" style="font-size: 12px; width: 120px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onchange="loadHTMLPost2('app/cashier_detail_ajax.php','item_ajax','getdata','item_code2')" value="<?php echo $item_code2 ?>" >
			</td>
			...
			<td>				
				<input type="text" id="item_name2" name="item_name2" class="form-control" style="width: auto" value="" >			
