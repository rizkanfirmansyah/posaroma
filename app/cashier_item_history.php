				...
				<div class="col-xs-12">
                    ...
                    <tbody>
                      	<?php
    						...
    						$sql=$selectview->list_cashier_item_history($client_code);
    						while($row_item=$sql->fetch(PDO::FETCH_OBJ)){
    						
                                $current_price    =    number_format($row_item->amount,"0",".",",");                                     $amount           =    number_format($row_item->current_price,"0",".",",");
    					...
    					?>
    	                    ...
    	                    <tr>
    	                    	...
    	                    	<td>
                                    <font style="font-size: auto"><?php echo $row_item->item_name ?></font>
                                </td>
    	                    	<td>
                                    <?php echo $row_item->uom_code ?>                                    
                                </td>
