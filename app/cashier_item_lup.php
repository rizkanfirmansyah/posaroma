...
<form name="frm" id="frm" method="post" action="cashier_item_lup.php">
    ...
    <script langauge="javascript">
    	function post_value(j){
        	...
        	var zz= "item_code2" + j
            opener.document.cashier.item_code2.value = aa.elements[zz].value;
        	
        	var xx= "item_name" + j
        	opener.document.cashier.item_name.value = aa.elements[xx].value;
            
            var yy= "uom_code" + j
            opener.document.cashier.uom_code.value = aa.elements[yy].value;
            
            var vv= "unit_price" + j
            opener.document.cashier.unit_price.value = aa.elements[vv].value;
            
            var ww= "amount" + j
            opener.document.cashier.amount.value = aa.elements[ww].value;
            
            var uu= "item_code" + j
            opener.document.cashier.item_code.value = aa.elements[uu].value;
            
            opener.document.cashier.qty.value = "1";
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                      	...
                      	<?php
    						...
    						$sql=$selectview->list_cashier_item_get_price();
    						while($row_item=$sql->fetch(PDO::FETCH_OBJ)){
    						
                                $current_price    =    number_format($row_item->current_price,"0",".",",");                                     $amount           =    number_format($row_item->current_price,"0",".",",");
    					...
    					?>
    	                    ...
    	                    <tr>
                                ...
                                <td align="right">
                                    <input type="hidden" id="unit_price<?php echo $j; ?>" name="unit_price<?php echo $j; ?>" value="<?php echo $current_price ?>" >
                                    <input type="hidden" id="amount<?php echo $j; ?>" name="amount<?php echo $j; ?>" value="<?php echo $amount ?>" >
                                
                                   <?php echo $current_price ?>&nbsp;</td>
