...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/cashier_view_xls.php?cashier="+cashier+"&receipt_type_pos="+receipt_type_pos+"&from_date="+date_from+"&to_date="+date_to+"&void="+void_; //+"&all="+all	
	}
</script>
