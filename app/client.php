	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				$ref2 = notran(date('Y-m-d'), 'frmclient_pos', '', '', ''); 
			...
			<form class="form-horizontal" role="form" action="" method="post" name="client" id="client" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('code,name');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="name" name="name" class="form-control" value="<?php echo $row_client->name ?>">
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmclient_pos')==1) { ?>
    						<?php if($ref=='') { ?>
