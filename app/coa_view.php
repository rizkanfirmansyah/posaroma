<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('coa_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('coa_view') ?>" />
			<?php
				}
			?>
								...
								?>
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <a href="main.php?menu=app&act=<?php echo obraxabrix('coa') ?>&search=<?php echo $row_coa->syscode ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													<span class="green">
