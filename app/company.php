...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="company" id="company" class="form-horizontal" onSubmit="return cekinput('name');">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Businiss Type</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Phone 1</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Phone 2</label>
					<div class="col-sm-3">
				...
				<div class="form-group"> 
					...
					<div class="col-sm-3">
						<input type="checkbox" name="active" id="active" class="ace" value="1" <?php echo $active ?> /><span class="lbl"></span>						
					</div>
				</div>		
				...
				<div class="form-group"> 
					...
					<div class="col-sm-3">
						<input style="background-color:#E2F6C5;" type="text" readonly size="20" id="uid" name="uid" value="<?php echo $row_company->uid ?>">
					</div>
				</div>
				...
				<div class="form-group"> 
					...
					<div class="col-sm-3">
						<input style="background-color:#E2F6C5;" type="text" readonly id="dlu" name="dlu" value="<?php echo $row_company->dlu ?>">
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . obraxabrix(company_view) ?>'" />
