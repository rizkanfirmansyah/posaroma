...
?>		    
            ...
            <select id="item_subgroup_id" name="item_subgroup_id" data-placeholder="Choose.." class="form-control chzn-select-deselect" tabindex="2" style="width: auto">
                <option value=""></option>
                <?php 
                    select_item_subgroup($item_group_id,"");
                ?>	                            
            </select>
<?php	
		break;
