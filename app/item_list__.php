...
<div class="page-content">		
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="item_view" id="item_view" class="form-horizontal" enctype="multipart/form-data" >
            	...
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Barcode/Kode Barang</label>
					<div class="col-sm-3">
						<input type="text" id="code" name="code" class="form-control" autofocus="" value="<?php echo $code ?>">
					</div>
				</div>
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php
            	include("app/exec/item_list_insert.php"); 
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" action="" method="post" name="item" id="item" enctype="multipart/form-data">
					...
					<div>
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="font-size: 12px">
							...
							<tbody>
                                <?php
									$sql=$selectview->list_item_check_barcode($code, $name);
									while($row_item=$sql->fetch(PDO::FETCH_OBJ)){
									
									$i++;
									
										$syscode = $row_item->syscode;
								...
								?>
                                    ...
                                    <input type="hidden" id="syscode" name="syscode" value="<?php echo $syscode ?>" />
                                    
							</tbody>
						</table>
						
						<?php include("item_list_set_price.php"); ?>
					</div>
