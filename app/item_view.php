							...
							<tbody>
								...
								?>
                                        ...
                                        <tr>
					                    	...
					                    	<td><?php echo $row_item->minimum_stock ?></td>
					                    	<td><?php echo $row_item->maximum_stock ?></td>
											<td>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmitem_pos')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('item') ?>&search=<?php echo $row_item->syscode ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmitem_pos')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $row_item->syscode ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
