...
<table border="0">
	...
	<tr style="background-color:ffffff;" id="item_ajax" > 
		...
		<td align="left" colspan="1">
            ...
            <input type="text" id="item_code2" name="item_code2" style="font-size: 11px; width: 150px" class="form-control" onchange="loadHTMLPost3('app/outbound_detail_ajax.php','item_ajax','getdata','item_code2','warehouse_id_from')" value="" />
