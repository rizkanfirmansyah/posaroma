...
<form name="frm" id="frm" method="post" action="outbound_item_lup.php">
    ...
    <script langauge="javascript">
    	function post_value(j){
        	...
        	var zz= "item_code2" + j
            opener.document.outbound.item_code2.value = aa.elements[zz].value;
        	
        	var xx= "item_name" + j
        	opener.document.outbound.item_name.value = aa.elements[xx].value;
            
            var yy= "uom_code" + j
            opener.document.outbound.uom_code.value = aa.elements[yy].value;
            
            var uu= "item_code" + j
            opener.document.outbound.item_code.value = aa.elements[uu].value;
            
            opener.document.outbound.qty.value = "1";
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                      	...
                      	<?php
    						...
    						$sql=$selectview->list_outbound_item_get();
    					...
    					?>
    	                    ...
    	                    <tr>
    	                    	...
    	                    	<td><input type="hidden" id="uom_code<?php echo $j; ?>" name="uom_code<?php echo $j; ?>" value="<?php echo $row_item->uom_code_stock ?>" ><?php echo $row_item->uom_code_stock ?></td>
