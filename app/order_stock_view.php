<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('order_stock_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/order_stock_view_xls.php?from_date="+date_from+"&to_date="+date_to;	
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_order_stock($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('order_stock_view') ?>" />
			<?php
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
                                    ...
                                    <th><?php if($lng==1) { echo 'Ref No'; } else { echo 'No. Order'; } ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <?php if (allowupd('frmorder_stock')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('order_stock') ?>&search=<?php echo $row_cashier->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
