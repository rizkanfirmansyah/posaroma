	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				$ref2 = notran(date('y-m-d'), 'frmoutbound_pos', '', '', ''); 
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="outbound" id="outbound" enctype="multipart/form-data" onSubmit="return cekinput('ref,date,warehouse_id_from,warehouse_id_to,type,employee_id');" >
					...
					<tr>
						<td>
							...
							<div class="form-group">
		                        ...
		                        <div class="col-sm-5">
		                          <select id="status2" name="status2" class="chosen-select form-control" style="width: auto">
		                            <?php 
							...
							?>
								<div class="form-group">
			                        <label class="col-sm-5 control-label no-padding-right" for="form-field-1">Dari Gudang *)</label>
			                        <div class="col-sm-5">
			                          <select id="warehouse_id_from" name="warehouse_id_from" class="chosen-select form-control" style="width: auto">
			                            <option value=""></option>
			                            <?php 
			                            	combo_select_active("warehouse","id","name","active","1",$warehouse_id_from)
			                            ?>	                            
			                          </select>
							...
							<div class="form-group">
		                        <label class="col-sm-5 control-label no-padding-right" for="form-field-1">Ke Gudang *)</label>
		                        <div class="col-sm-5">
		                          <select id="warehouse_id_to" name="warehouse_id_to" class="chosen-select form-control" style="width: auto">
		                            <option value=""></option>
		                            <?php 
		                            	combo_select_active("warehouse","id","name","active","1",$warehouse_id_to)
		                            ?>	                            
		                          </select>
								</div>
							</div>
							...
							<?php /*
							<div class="form-group">
		                        <label class="col-sm-5 control-label no-padding-right" for="form-field-1">Tipe Pengeluaran *)</label>
		                        <div class="col-sm-5">
		                          <select id="type" name="type" class="chosen-select form-control" style="width: auto">
		                            <?php 
		                            	select_outbound_type($row_outbound->type) 
		                            ?>	
						...
						<td>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Catatan</label>
								<div class="col-sm-5">
							...
							<?php /*
			             	<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1">No Keluar</label>
								<div class="col-sm-5">
									<input type="text" id="form_no" name="form_no" class="form-control" value="<?php echo $row_outbound->form_no ?>">
								</div>
							</div>*/ ?>
							
							<div class="form-group">
		                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Nama Pengirim *)</label>
		                        <div class="col-sm-6">
		                          <select id="employee_id" name="employee_id" class="chosen-select form-control" style="width: auto; ">
		                            <option value=""></option>
		                            <?php 
							...
							<div class="form-group">
		                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Nama Penerima</label>
		                        <div class="col-sm-6">
		                          <select id="employee_id2" name="employee_id2" class="chosen-select form-control" style="width: auto; ">
		                            <option value=""></option>
		                            <?php 
			             	...
			             	<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Diupdate Oleh</label>
								<div class="col-sm-2">
				            ...
				            <?php /*
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Date Last Update</label>
								<div class="col-sm-5">
									<input type="text" id="dlu" name="dlu" readonly class="form-control" value="<?php echo $row_outbound->dlu ?>" >
								</div>
							</div>*/ ?>
					...
					<tr>
						<td colspan="2">
			            	...
			            	if ($ref=='') {		
								...
								include_once("outbound_detail_input.php");
								
								if($xndf != "") {
									include("outbound_get_detail.php");
								} /*else {
						...
						<td colspan="2">
							...
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
			                        ...
			                        <?php if (allowadd('frmoutbound_pos')==1) { ?>
										<?php if($ref=='') { ?>
											<input type="submit" name="submit" class='btn btn-primary' value="Save">
										<?php } ?>
									<?php } ?>
									
									<?php if (allowupd('frmoutbound_pos')==1) { ?>
										<?php if($ref!='') { ?>													
											<input type="submit" name="submit" class='btn btn-primary' value="Update">
										<?php } ?>
									<?php } ?>
									
									<?php if (allowdel('frmoutbound_pos')==1) { ?>
									...
									<input type="button" name="submit" class="btn btn-success" value="List" onClick="self.location='main.php?menu=app&act=<?php echo obraxabrix(outbound_view) ?> '">
