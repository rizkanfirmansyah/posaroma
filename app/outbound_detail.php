<?php
 ...
 <table width="100%" class="table table-bordered table-condensed table-hover table-striped" style="width: auto; font-size: 11px">
	<thead>
		<tr style="color: #168124; font-weight: bold; border: 1px solid #ccc; font-size:16px; background-color: #e6ffea"> 
	...
	?>
		...
		<tr>
			<td colspan="5" style="color: #d50000; font-weight: bold; font-size: 16px;">
		...
		<?php 
			...
			$sql=$select->list_outbound_detail($ref, $row_outbound_group->item_group_id);
