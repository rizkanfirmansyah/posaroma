...
<script>
	//window.location = 'http://localhost:8080/tokosahabat/app/outbound_print_go.php';
	//window.location = 'http://localhost/tokosahabat/app/outbound_print_go.php';
	//window.location = 'http://localhost:8080/tokosahabat/app/outbound_print_go_ol.php?uid=<?php echo $uid ?>';
	window.location = 'http://localhost/tokosahabat/app/outbound_print_go_ol.php?uid=<?php echo $uid ?>'; //online			
</script>
