<?php
	...
	if ($delete == "xm8r389xemx23xb2378e23") {
		...
		$delete2=new delete;
		$delete2->delete_payment($_REQUEST['id']);
?>
...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('payment_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmpayment')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('payment') ?>&search=<?php echo $row_payment->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
