...
*                                                                              *
*******************************************************************************/
function FPDF2($orientation='P', $unit='mm', $format='A4', $size='0')
{
	//Some checks
	$this->_dochecks();
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'auto'=>array(595, $size), 'tmsize'=>array(350, $size), 'tmusize'=>array(297, $size) );
	if(is_string($format))
