...
<script>
	...
	function detailvalue(id, jmldata, ketik) {
		...
		if (ketik == 'persen') {
			$('#discount_det_id' + id).html('<input type="text" id="discount_' + id + '" name="discount_' + id + '" style="text-align: right; font-size:18px" class="form-control" onkeyup="formatangka(\'discount_' + id + '\'), detailvalue(\'' + id + '\', ' + jmldata + ', \'nominal\')" value="' + discount_value + '" >');
		}
		...
		if (ketik == 'nominal') {
			$('#discount3_det_id' + id).html('<input type="text" id="discount3_' + id + '" name="discount3_' + id + '" style="text-align: right; font-size:18px" class="form-control" onkeyup="formatangka(\'discount3_' + id + '\'), detailvalue(\'' + id + '\', ' + jmldata + ', \'persen\')" value="' + discount3_value + '" >');
		...
		$('#amount' + id).html('<input type="text" onkeyup="formatangka(\'amount_' + id + '\')" id="amount_' + id + '" name="amount_' + id + '" value="' + amount + '" readonly style="text-align:right; font-size: 18px; color: #000000; font-weight: bold;" class="form-control" >');
	...
	function subtotal2(jumlah) {
		...
		$('#total_id').html('<input type="text" id="total" name="total" readonly style="text-align: right; font-size: 28px; font-weight: bold; color: #000000; font-weight: bold;" class="form-control" onkeyup="formatangka(' + total + ')" value="' + jumlah + '"" >');

		change_amount = number_format(change_amount, 0, ".", ",");
		$('#change_amount_id').html('<input type="text" id="change_amount" name="change_amount" readonly="" style="text-align: right; font-size: 28px; font-weight: bold; color: #000000; font-weight: bold;" class="form-control" value="' + change_amount + '"" >');
...
<script language="javascript">
	...
	function update(id, no) {
		...
		document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('pos') ?>&mxKz=upd&xndf=" + id + "&line=" + line + "&qty=" + qty + "&unit_price=" + unit_price + "&amount=" + amount + " ";
		...
		<div class="col-xs-12">
			...
			if ($xndf != "") {
				...
				if ($delete == "upd" && $post != "Save Detail") {
					$update2 = new update;
					$update2->update_pos_detail($_REQUEST['xndf'], $_REQUEST['line'], $_REQUEST['qty'], $_REQUEST['unit_price'], $_REQUEST['amount'], $_REQUEST['item_code'], $_REQUEST['uom_code']);
				}
					...
					<tr>
						<td>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if ($lng == 1) {
																												echo 'Ref. No.';
																											} else {
																												echo 'No. Nota';
																											} ?> *)</label>
								<div class="col-sm-4">
									<input type="text" id="ref" name="ref" readonly="" style="font-size: 14px; color: #000000;" class="form-control" value="<?php echo $ref2 ?>">
						...
						<td>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="date" name="date" style="font-size: 14px; color: #000000;" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $date ?>">
								</div>
							</div>
						</td>
						...
						<td>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select id="location_id2" name="location_id2" class="chosen-select form-control" disabled="" style="max-width: 250px; font-size: 14px; color: #000000;">
										<option value=""></option>
										<?php
					...
					<tr>
						<td>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea id="memo" name="memo" style="font-size: 14px; color: #000000; width: 300px" class="autosize-transition form-control"><?php echo $row_pos->memo ?></textarea>
								</div>
							</div>
						</td>
						...
						<td>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="shift" name="shift" style="font-size: 14px; color: #000000;" class="form-control" value="<?php echo $shift ?>">
								</div>
							</div>
						</td>
						...
						<td>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="uid" name="uid" readonly="" style="font-size: 14px; color: #000000;" class="form-control" value="<?php echo $uid ?>">
								</div>
							</div>
						</td>
					</tr>
						...
						<td>
							<div id="new_client">
										...
										<div class="col-sm-3">
											<div class="checkbox">
												<label style="color: #ff0000">
													<input id="newclient" name="newclient" class="uniform" type="checkbox" onClick="loadHTMLPost2('app/pos_ajax.php','new_client','getclient','newclient')" value="0"><b><?php if($lng==1) { echo 'New Customer'; } else { echo 'Customer Baru'; } ?></b>
												</label>
											</div>
								...
								<div class="form-group">
			                        ...
			                        <div class="col-sm-3">
			                        	 <select id="client_code" name="client_code" class="chosen-select form-control"  style="max-width: 300px; font-size: 12px;" <?php echo $disabled ?> onchange="loadHTMLPost2('app/pos_client_ajax.php','alamat','getalamat','client_code')" >
				                          	<option value=""></option>
				                            <?php 
					...
					<tr>
						...
						<td colspan="3" style="font-size: 16px; font-weight: bold;">
							<table>
								<tr id="point_id">
									<td>
										<input type="hidden" id="client_member_code" name="client_member_code" value="<?php echo $row_pos->client_member_code; ?>">

										Member No. :
										<input type="text" id="client_member_code2" name="client_member_code2" class="form-control" style="width: auto; font-size: 16px" onblur="loadHTMLPost2('app/pos_ajax.php','point_id','getmember','client_member_code2')" value="<?php echo $row_pos->client_member_code2; ?>">
									</td>

									<td>
										Nama Member :
										<input type="text" id="member_name" name="member_name" class="form-control" style="width: 400px; font-size: 16px" readonly="" value="<?php echo $row_pos->member_name; ?>">
									</td>

									<td>
										Point :
										<input type="text" id="point" name="point" class="form-control" style="width: auto; font-size: 16px" readonly="" value="<?php echo $row_pos->point; ?>">
									</td>
								</tr>
							</table>
