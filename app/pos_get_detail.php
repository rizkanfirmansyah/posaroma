...
<table width="100%" class="table table-bordered table-condensed" style="font-size: <?php echo $font_size ?>; background-color: #010596; color: #ffffff;">
	...
	<tbody>
		...
		?>
			...
			<tr style="background-color: #010596; color: #ffffff" id="item_ajax2_<?php echo $no; ?>">
				...
				<td align="center" style="width: 70px; font-size: <?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
					<input type="hidden" id="item_code2_<?php echo $no ?>" name="item_code2_<?php echo $no ?>" class="form-control" readonly="" style="width: 70px; font-size: <?php echo $font_size ?>; color: #000000; font-weight: bold; height: 25px" value="<?php echo $row_pos_detail->old_code; ?>">
				...
				<td style="background-color: #010596; width: 350px; font-size: <?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
					<input type="hidden" id="item_name_<?php echo $no ?>" name="item_name_<?php echo $no ?>" class="form-control" style="background-color: #010596; width: 300px; font-size: <?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px" value="<?php echo $row_pos_detail->item_name; ?>">
				...
				<td style="width: 50px; font-size: <?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
					<input type="hidden" id="uom_code_<?php echo $no ?>" name="uom_code_<?php echo $no ?>" class="form-control" readonly="" style="width: 50px; font-size: <?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px" value="<?php echo $row_pos_detail->uom_code; ?>">
					<?php echo $row_pos_detail->uom_code; ?>
				</td>
				<td align="center" id="qty_id<?php echo $no; ?>" style="background-color: #010596; width: 70px; font-size: <?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
				...
				<td align="right" style="width: 100px; text-align: right; font-size:<?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
					<input type="hidden" id="unit_price_<?php echo $no; ?>" name="unit_price_<?php echo $no; ?>" style="width: 100px; text-align: right; font-size:<?php echo $font_size ?>; color: #000000; font-weight: bold; height: 25px" class="form-control" onkeyup="formatangka('unit_price_<?php echo $no; ?>'), detailvalue('<?php echo $no ?>', '<?php echo $jmldata ?>')" readonly="" value="<?php echo $unit_price ?>">
					<?php echo $unit_price ?>
				</td>
				...
				<td align="center" id="discount3_det_id<?php echo $no; ?>" style="width: 70px; text-align: right; font-size:<?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
					<input type="hidden" id="discount3_<?php echo $no; ?>" name="discount3_<?php echo $no; ?>" style="width: 50px; text-align: right; font-size:<?php echo $font_size ?>; color: #000000; font-weight: bold; height: 25px" class="form-control" onkeyup="formatangka('discount3_<?php echo $no; ?>'), detailvalue('<?php echo $no ?>', '<?php echo $jmldata ?>','persen')" readonly="" value="<?php echo $discount3_det ?>">
				...
				<td align="center" id="amount<?php echo $no; ?>" style="width: 130px; text-align: right; font-size:<?php echo $font_size ?>; color: #ffffff; font-weight: bold; height: 25px">
					<input type="hidden" id="amount_<?php echo $no; ?>" name="amount_<?php echo $no; ?>" style="width: 100px; text-align: right; font-size:<?php echo $font_size ?>; color: #000000; font-weight: bold; height: 25px" class="form-control" onkeyup="formatangka('amount_<?php echo $no; ?>')" readonly value="<?php echo $amount ?>">
					<?php echo $amount ?>
				</td>
		...
		<tr style="background-color: #010596; color: #ffffff">
			...
			<td align="right">
				<input type="text" id="discount" name="discount" style="width: 130px; height: 25px; text-align: right; font-size: <?php echo $font_bottom ?>; font-weight: bold; color: #000000;" class="form-control" onkeyup="formatangka('discount'), sub_total('<?php echo $jmldata ?>')" autocomplete="off" readonly="" value="<?php echo number_format($discount2, 0, ".", ",") ?>">
			</td>
		</tr>
		...
		<tr style="background-color: #010596; color: #ffffff">
			...
			<td align="right" id="total_id">
				<input type="text" id="total" name="total" readonly="" style="width: 130px; height: 25px; text-align: right; font-size: <?php echo $font_bottom ?>; font-weight: bold; color: #000000;" class="form-control" onkeyup="formatangka('total')" value="<?php echo $total2 ?>">
			</td>

		</tr>

		<tr style="background-color: #010596; color: #ffffff;">
			<!--<td colspan="4" align="right" style="font-size: 14px; font-weight: bold;"><?php if ($lng == 1) {
		...
		<tr style="background-color: #010596; color: #ffffff">
			...
			<td align="right">
				<input type="text" id="ovo" name="ovo" autocomplete="off" style="width: 130px; height: 25px; text-align: right; font-size: <?php echo $font_bottom ?>; font-weight: bold; color: #000000;" class="form-control" onkeyup="formatangka('ovo')" oninput="sub_total('<?php echo $jmldata ?>')" onKeyPress="return focusNext('submit',event)" value="<?php echo $ovo ?>">
			</td>
		</tr>
		...
		<tr style="background-color: #010596; color: #ffffff">
			...
			<td align="right">
				<input type="text" id="cash_voucher" name="cash_voucher" autocomplete="off" style="width: 130px; height: 25px; text-align: right; font-size: <?php echo $font_bottom ?>; font-weight: bold; color: #000000;" class="form-control" onkeyup="formatangka('cash_voucher')" oninput="sub_total('<?php echo $jmldata ?>')" onKeyPress="return focusNext('submit',event)" value="<?php echo $cash_voucher ?>">
			</td>
		</tr>
		...
		<tr style="background-color: #010596; color: #ffffff">
			...
			<td align="right" id="change_amount_id">
				<input type="hidden" id="change_amount" name="change_amount" readonly="" style="width: 130px; height: 25px; text-align: right; font-size: <?php echo $font_bottom ?>; font-weight: bold; color: #000000;" class="form-control" onkeyup="formatangka('change_amount')" value="<?php echo number_format($change_amount, 0, ".", ",") ?>">
			</td>
		</tr>
