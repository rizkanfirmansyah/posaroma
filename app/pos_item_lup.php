...
<form name="frm" id="frm" method="post" action="pos_item_lup.php">
    ...
    <script langauge="javascript">
    	function post_value(j){
        	...
        	var zz= "item_code2" + j
            opener.document.pos.item_code2.value = aa.elements[zz].value;
        	
        	var xx= "item_name" + j
        	opener.document.pos.item_name.value = aa.elements[xx].value;
            
            var yy= "uom_code" + j
            opener.document.pos.uom_code.value = aa.elements[yy].value;
            
            var vv= "unit_price" + j
            opener.document.pos.unit_price.value = aa.elements[vv].value;
            
            var ww= "amount" + j
            opener.document.pos.amount.value = aa.elements[ww].value;
            
            var uu= "item_code" + j
            opener.document.pos.item_code.value = aa.elements[uu].value;
            
            opener.document.pos.qty.value = "1";
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                      	...
                      	<?php
    						...
    						$sql=$selectview->list_pos_item_get_price();
