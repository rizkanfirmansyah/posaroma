...
<script>
	//window.location = 'http://localhost:8080/tokosahabat/app/pos_print_go.php';
	window.location = 'http://localhost/tokosahabat/app/pos_print_go.php';			
</script>
