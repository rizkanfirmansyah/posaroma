...
<script>
	...
	//var url  = "http://localhost:8080/tokosahabat/main.php?menu=app&act=<?php echo obraxabrix(pos) ?>";
	//var url  = "http://possp.sahabatputra.com/main.php?menu=app&act=<?php echo obraxabrix(pos) ?>";
	var url  = "http://pos.dianglobaltech2.com/main.php?menu=app&act=<?php echo obraxabrix(pos) ?>";
	window.location = url;
