...
<script>
	...
	window.location = 'http://localhost/aromapos/app/pos_view_print_ol.php?uid='+uid+'&uid_print='+uid_print+'&from_date='+from_date+'&to_date='+to_date+'&shift='+shift+'&all='+all+'&void='+__void+'&receipt_type_pos='+receipt_type_pos; //online
