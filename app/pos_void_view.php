...
if($_SESSION['adm'] == 0 && $location_id_hd == '') {
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/pos_void_xls.php?cashier="+cashier+"&receipt_type_pos="+receipt_type_pos+"&from_date="+date_from+"&to_date="+date_to; //+"&all="+all	
	}
</script>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="purchase_view" id="purchase_view" class="form-horizontal" enctype="multipart/form-data" >
						...
						<div class="form-group">
		                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kode/Barcode Barang</label>
		                    
		                    <div class="col-sm-3">
		                    	 <input type="text" id="item_code" name="item_code" style="font-size: 12px" class="form-control" value="<?php echo $item_code ?>">
		                    	 <?php /*
		                    	 <select id="item_code" name="item_code" class="chosen-select form-control"  style="max-width: 300px; font-size: 12px;" >
		                          	<option value=""></option>
		                            <?php 
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th><?php if($lng==1) { echo 'Item'; } else { echo 'Barang Batal'; } ?></th>
								</tr>
							</thead>
                    						...
                    						<td>
                    							<table width="100%" border="1" style="border: 1px solid #93d145">
				                            		<tr style="background: #d3fe7a">
				                            			...
				                            			<td align="center" width="70%"><?php if($lng==1) { echo 'Item Name'; } else { echo 'Nama Barang'; } ?></td>
				                            			<td align="center" width="20%"><?php if($lng==1) { echo 'UoM'; } else { echo 'Satuan'; } ?></td>
				                            			<td align="center" width="20%"><?php if($lng==1) { echo 'Qty'; } else { echo 'Qty'; } ?></td>
				                            			<td align="center" width="20%"><?php if($lng==1) { echo 'Amount'; } else { echo 'Total'; } ?></td>
				                            			<td align="center" width="20%">User Void</td>
				                            		</tr>
				                            		<?php 
				                            			$x = 0;
				                            		...
				                            		<tr>
				                            			...
				                            			<td>&nbsp;<?php echo $row_void->item_name ?></td>
				                            			<td>&nbsp;<?php echo $row_void->uom_code ?></td>
				                            			<td align="center"><?php echo number_format($row_void->qty,0,'.',',') ?></td>
				                            			<td align="center"><?php echo number_format($row_void->amount,0,'.',',') ?></td>
				                            			<td>&nbsp;<?php echo $row_void->uid ?></td>
				                            		</tr>
				                            		<?php
							...
							<tr style="font-weight: bold; color: #0e630e">
                    			<td align="right" colspan="5">TOTAL&nbsp;</td>
                    			<td align="center">Qty : <?php echo number_format($total_qty,0,'.',',') ?></td>
