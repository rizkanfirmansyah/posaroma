...
<script language="javascript">
	...
	function print() {
		...
		window.open('app/purchase_inv_print.php?ref='+ref, 'Invoice Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				$ref2 = notran(date('y-m-d'), 'frmpurchase_inv_pos', '', '', ''); 
					...
					<tr>
						<td>
			            	<div class="form-group">
								...
								<div class="col-sm-5" style="font-size: 22px; font-weight: bold;" id="total_id_top">
								TOTAL : <?php 
								
										if($ref == "") {
											echo number_format($select->list_purchase_inv_total_tmp($xndf),2,".",","); 
										} else {
											echo number_format($select->list_purchase_inv_total($ref),2,".",","); 
										}
						...
						<td>							
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<input type="text" id="memo" name="memo" style="font-size: 12px" class="form-control" onKeyPress="return focusNext('item_code2',event)" value="<?php echo $row_purchase_inv->memo ?>"> 
								</div>
							</div>
						</td>
					</tr>
						...
						<td colspan="2">
							...
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
			                        ...
			                        <?php if (allowadd('frmpurchase_inv_pos')==1) { ?>
			    						<?php if($ref=='') { ?>
									...
									&nbsp;&nbsp;&nbsp;
									<input type="button" name="submit" id="submit" class="btn btn-success" value="Form Baru" onclick="self.location='<?php echo $nama_folder . obraxabrix(purchase_inv) ?>'" />
