	...
	<tbody>
		...
		?>								
			...
			<tr style="background-color:ffffff;" id="item_ajax2_<?php echo $no; ?>" > 
				...
				<td>				
					<input type="text" id="item_code2_<?php echo $no ?>" name="item_code2_<?php echo $no ?>" class="form-control" readonly="" style="width: 80px" value="<?php echo $row_purchase_inv_detail->old_code; ?>" >
				</td>
				<td>				
					<input type="text" id="item_name_<?php echo $no ?>" name="item_name_<?php echo $no ?>" class="form-control" readonly="" style="width: 290px" value="<?php echo $row_purchase_inv_detail->item_name; ?>" >
				</td>
				<td>
			...
			<tr>
				...
				<td align="right">
					<input type="text" id="cash_amount" name="cash_amount" style="text-align: right; font-size: 14px; font-weight: bold; width: 150px" class="form-control" onkeyup="formatangka('cash_amount'), sub_total('<?php echo $jmldata ?>')" value="<?php echo $cash_amount ?>" >
				</td>
			</tr>
