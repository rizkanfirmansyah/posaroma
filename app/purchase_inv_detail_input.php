<div class="form-group">
	...
	<div class="col-sm-12">
		...
		<span class="input-icon">	
			<input type="text" id="qty" name="qty" style="text-align: right; width: 60px" oninput="loadHTMLPost4('app/purchase_inv_detail_qty_ajax.php','item_ajax_qty','getdata','item_code2','location_id','qty')" onKeyPress="return focusNext('unit_cost',event)" autocomplete="off" onkeyup="formatangka('qty'), detailvalue2()" value="" >
		</span>
		...
		<span class="input-icon">
			&nbsp;<input type="hidden" id="submit_det" name="submit" class="btn btn-metis-2 btn-sm" style="height: 34px" value="Save Detail" onClick="return confirm('Apakah data sudah betul?')">
		</span>
