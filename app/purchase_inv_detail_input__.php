...
<table width="30%" border="0">
    <tr>
        <td>
			<select id="item_code" name="item_code" class="chosen-select form-control" style="width: auto; font-size: 11px" onKeyPress="return focusNext('item_code2',event)" onchange="loadHTMLPost3('app/purchase_inv_detail_ajax.php','item_ajax','getdata2','item_code','location_id')" >
				<option value=""></option>
				<?php 
					select_item("")
				?>	
		...
		<td>
            <a href="javascript:void(0);" name="Find" title="Find" onClick=window.open("app/purchase_inv_item_lup.php","Find","width=900,height=500,left=200,top=20,toolbar=0,status=0,scroll=1,scrollbars=no");><img src="assets/img/plus.png" /></a>
...
<table border="0">
	...
	<tr style="background-color:ffffff;" id="item_ajax" > 
		...
		<td align="left" colspan="1">
            ...
            <input type="text" id="item_code2" name="item_code2" style="font-size: 11px; width: 150px" class="form-control" onchange="loadHTMLPost3('app/purchase_inv_detail_ajax.php','item_ajax','getdata','item_code2','location_id')" autofocus="" value="" />
