<div class="form-group">
	...
	<div class="col-sm-12">
		<span id="item_ajax">
			...
			<input type="text" id="item_code2" name="item_code2" style="width: 150px" onchange="loadHTMLPost3('app/purchase_inv_detail_ajax.php','item_ajax','getdata','item_code2','location_id')" autofocus="" autocomplete="off" onKeyPress="return focusNext('qty',event)" value="" />
			
			<input type="text" id="item_name" name="item_name" readonly="" style="width: 300px" value="<?php echo $item_name ?>" >
		...
		<span class="input-icon">	
			<input type="text" id="qty" name="qty" style="text-align: right; width: 60px" oninput="loadHTMLPost4('app/purchase_inv_detail_qty_update_ajax.php','item_ajax_qty','getdata','item_code2','location_id','qty')" onKeyPress="return focusNext('unit_cost',event)" autocomplete="off" onkeyup="formatangka('qty'), detailvalue2()" value="" >
		</span>
		
		<span class="input-icon" id="item_ajax_qty">
			<input type="hidden" id="unit_cost" name="unit_cost" style="text-align: right; width: 100px" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('unit_cost'), detailvalue2()" value="" >
		
			<input type="hidden" id="discount3_1_det" name="discount3_1_det" style="text-align: right; width: 90px" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('discount3_1_det'), detailvalue2('persen')" value="" >
		...
		<span class="input-icon">
			&nbsp;<input type="hidden" id="submit_det" name="submit" class="btn btn-metis-2 btn-sm" style="height: 34px" value="Add Detail" onClick="return confirm('Apakah data sudah betul?')">
		</span>
