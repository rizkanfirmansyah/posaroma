...
?>		
		<!--<tr style="background-color:ffffff;" id="item_ajax2_<?php echo $no; ?>" > -->
    		...
    		<input type="hidden" id="discount3_3_det" name="discount3_3_det" style="text-align: right; width: 90px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('discount3_3_det'), detailvalue2('persen')" value="" />
			...
			<td align="left">
				<input type="text" id="item_code2" name="item_code2" style="width: 150px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onchange="loadHTMLPost3('app/purchase_inv_detail_ajax.php','item_ajax','getdata','item_code2','location_id2')" value="<?php echo $kode ?>" >
			</td>
			
			<td align="left">
				<input type="text" id="item_name" name="item_name" readonly="" style=" width: auto; min-width: 300px" class="form-control" value="<?php echo $item_name ?>" >
			</td>
			...
			<td align="center">
				<input type="text" id="qty" name="qty" style="text-align: right; width: 60px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('qty'), detailvalue2('persen')" autofocus="" value="1" >
			</td>
			<td align="center">
				<input type="text" id="unit_cost" name="unit_cost" style="text-align: right; width: 100px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('unit_cost'), detailvalue2('persen')" value="<?php echo $current_cost ?>" >
			</td>
    		...
    		*/ ?>
            ...
            <td align="center" id="discount3_1_det_id">
    			<input type="text" id="discount3_1_det" name="discount3_1_det" style="text-align: right; width: 90px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('discount3_1_det'), detailvalue2('persen')" value="<?php echo $discount1 ?>" >
    		</td>
            ...
            <td align="center" id="discount_det_id">
				...
				<input type="text" id="discount_det" name="discount_det" style="text-align: right; width: 90px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('discount_det'), detailvalue2('nominal')" value="<?php echo $discount ?>" >
			</td>
			
			<td align="center" id="amount_det">
				<input type="text" id="amount" name="amount" readonly="" style="text-align: right; width: 100px" class="form-control" onkeyup="formatangka('amount')" value="<?php echo $amount ?>" >
			</td>
...
<?php
	...
	case "getdata2":
		...
		$no = $kodex;
		$sqlstr = "select code, syscode, uom_code_sales uom_code from item where (syscode=trim('$kode') or code=trim('$kode') or old_code=trim('$kode')) limit 1";
		$sql=$dbpdo->prepare($sqlstr);
		$sql->execute();
		$data 	= $sql->fetch(PDO::FETCH_OBJ); 
...
?>		
			...
			<td align="left">
				<input type="text" id="item_code2" name="item_code2" style="font-size: 11px; width: 150px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onchange="loadHTMLPost2('app/purchase_inv_detail_ajax.php','item_ajax','getdata','item_code2')" value="<?php echo $item_code2 ?>" >
			</td>
