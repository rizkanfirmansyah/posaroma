				...
				<div class="col-xs-12">
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$selectview->rpt_ar_outstanding($from_date, $to_date, $client_code, $all);			
								...
								?>
                                        ...
                                        <tr>
					                    	...
					                    	<td align="right"><?php echo number_format($row_rpt_ar->debit_amount,0,".",",") ?></td>
					                    	<td align="right"><?php echo number_format($row_rpt_ar->credit_amount,0,".",",") ?></td>
					                    	<td align="right"><?php echo number_format($row_rpt_ar->amount,0,".",",") ?></td>
											<td>
                                            
                                                <?php if (allowupd('frmreceipt')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('receipt2') ?>&clncde=<?php echo $row_rpt_ar->contact_code ?>&invno=<?php echo $row_rpt_ar->invoice_no ?>" class="tooltip-success" data-rel="tooltip" title="Receipt">
    													<span class="green">
