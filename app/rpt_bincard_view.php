...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:#ccc; font-family: Arial; font-size: 11px">	
	...
	?>
		...
		<tr style="background-color: #f1feb4">
			...
			<td align="left">&nbsp;<?php echo $row_bincard2->uom_code ?></td>
		...
		<?php
			...
			$sql2 = $selectview->rpt_bincard($row_bincard2->item_code, $location_code, $row_bincard2->uom_code, $date_from, $date_to, $all);	
			...
			?>
				...
				<tr>
					...
					<td align="right" <?php echo $style ?> ><?php echo number_format($debit_qty,"2",",",".") ?>&nbsp;</td>
					<td align="right" <?php echo $style ?> ><?php echo number_format($credit_qty,"2",",",".") ?>&nbsp;</td>
					
					<?php 
						if($transaction == "Stock Opname") {
					?>
							<td align="right" <?php echo $style ?> ><?php echo number_format($total_qty,"2",",",".") ?>
								<br>
								<?php echo number_format($qty_tmp,"2",",",".") ?>&nbsp;
							</td>
					<?php } else { ?>
							<td align="right" <?php echo $style ?> ><?php echo number_format($total_qty,"2",",",".") ?>&nbsp;</td>
					<?php } ?>
				</tr>
			...
			<tr style="font-weight: bold; font-size: 14px; color: #0404f9">
				...
				<td align="right"><?php echo number_format($total_credit,"2",",",".") ?>&nbsp;</td>
