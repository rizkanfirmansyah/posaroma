...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/rpt_sales_global_xls.php?cashier="+cashier+"&location_id="+location_id+"&from_date="+date_from+"&to_date="+date_to+"&all="+all;
	}
</script>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
                                    ...
                                    <th><?php if($lng==1) { echo 'Store Name'; } else { echo 'Nama Unit'; } ?></th>
                                    <th><?php if($lng==1) { echo 'Cashier'; } else { echo 'Kasir'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Sales Total'; } else { echo 'Jumlah Sales'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Cash Amount'; } else { echo 'Modal'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Total Sales'; } else { echo 'Total'; } ?></th>
			                    	<th></th>
							...
							<tbody>
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $row_sales->date ?></td>
                                            <td><?php echo $row_sales->location_name ?></td>
                                            <td><?php echo $row_sales->uid ?></td>
					                    	<td align="right"><?php echo number_format($row_sales->total,0,".",",") ?></td>
					                    	<td align="right"><?php echo number_format($modal,0,".",",") ?></td>
							...
							<tr style="font-weight: bold; font-size: 16px; background-color: #c5fec0">
                                <td colspan="4" align="right"><?php echo "Grand Total" ?></td>
		                    	<td align="right"><?php echo number_format($grand_total,0,".",",") ?></td>
		                    	<td align="right"><?php echo number_format($grand_modal,0,".",",") ?></td>
		                    	<td align="right"><?php echo number_format($grand_sales,0,".",",") ?></td>
		                    	<td>
