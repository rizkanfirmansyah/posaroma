...
if($item_code != "") {
	$sqlitem = $selectview->get_item($item_code);
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/rpt_sales_item_xls.php?item_code="+item_code+"&location_id="+location_id+"&from_date="+date_from+"&to_date="+date_to+"&all="+all;
	}
</script>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
			                    	...
			                    	<th><?php if($lng==1) { echo 'Total Qty'; } else { echo 'Total Qty'; } ?></th>
			                    	<th></th>
							...
							<tbody>
                                <?php			
                                	$total_qty = 0;
									$sql=$selectview->rpt_sales_item($ref, $item_code, $from_date, $to_date, $location_id, $all);			
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $row_sales->old_code ?></td>
					                    	<td><?php echo $row_sales->item_name ?></td>
				                            <td><?php echo $row_sales->uom_code ?></td>
					                    	<td align="right"><?php echo number_format($row_sales->total_qty,0,".",",") ?></td>
					                    	<td>
							...
							<tr style="font-weight: bold; color: #024802">
