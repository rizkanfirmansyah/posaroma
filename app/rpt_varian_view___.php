...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:#ccc; font-family: Arial; font-size: 14px">	
	...
	?>
		...
		<tr>
			<td colspan="11" style="font-weight: bold; font-size: 16px; background-color: #edfab4; height: 30px">
			...
			<?php	
				$sql = $selectview->rpt_varian($from_date, $to_date, $item_code, $uom_code, $item_group_id, $item_subgroup_id, $row_varian_vdr->vendor_code, $location_id, $all);	
