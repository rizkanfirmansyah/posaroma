...
<div class="page-content">		
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="set_item_price" id="set_item_price" class="form-horizontal" enctype="multipart/form-data" >
            	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kode Barang</label>
					<div class="col-lg-3">
						<input type="text" id="code" name="code" autocomplete="off" class="form-control" onchange="loadHTMLPost2('app/set_item_price_ajax.php','item_name','getitem','code')" value="<?php echo $code ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<input type="text" id="old_code" name="old_code" class="form-control" onchange="loadHTMLPost2('app/set_item_price_ajax.php','item_name','getitem','old_code')" value="<?php echo $old_code ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Barang</label>
					<div class="col-lg-3" id="item_name">
							...
							<tbody>
								...
								?>
                                        ...
                                        <tr>
					                    	...
					                    	<td><?php echo $row_item->uom_code_purchase ?></td>
											<!--<td>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmitem')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('set_item_price') ?>&search=<?php echo $row_item->syscode ?>" class="tooltip-success" data-rel="tooltip" title="Setup Harga">
    													<span class="green">
