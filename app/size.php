...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="size" id="size" enctype="multipart/form-data" onSubmit="return cekinput('code,name');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<?php if($ref=='') { ?>
							<input class="uniform" type="checkbox" name="active" id="active" value="1" checked />
						<?php } else { ?>
							<input class="checkbox" type="checkbox" name="active" id="active" value="1" <?php if($row_size->active==1) echo "checked";?>/>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="uid" name="uid" readonly class="form-control" value="<?php echo $row_size->uid ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dlu" name="dlu" readonly class="form-control" value="<?php echo $row_size->dlu ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="active" id="active" value="1" <?php if($row_size->active==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . obraxabrix(size_view) ?>'" />
