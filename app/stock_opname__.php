		...
		<div class="col-xs-12">
				    ...
				    <table border="0" width="90%" />
				    	<?php /*
				          <tr>
				          	<td colspan="2">
				          		<select id="item_code2" name="item_code2" class="chosen-select form-control" onchange="loadHTMLPost2('app/stock_opname_ajax.php','item_ajax','getdata','item_code2')" style="width: auto">
				          ...
				          <tr style="border: 1px solid #cccccc;">
				          	<td width="20%" align="center" style="border-right: 1px solid #cccccc;"><?php if($lng==1) { echo 'Item Code'; } else { echo 'Kode Barang'; } ?></td>
				          	<td width="40%" align="center" style="border-right: 1px solid #cccccc;"><?php if($lng==1) { echo 'Item Name'; } else { echo 'Name Barang'; } ?></td>
				          	<td width="5%" align="center" style="border-right: 1px solid #cccccc;"><?php if($lng==1) { echo 'Unit'; } else { echo 'Satuan'; } ?></td>
				          	<td width="15%" align="center" style="border-right: 1px solid #cccccc;"><?php if($lng==1) { echo 'Qty'; } else { echo 'Jml Barang'; } ?></td>
				          	<td width="15%" align="center"><?php if($lng==1) { echo 'Unit Cost'; } else { echo 'Harga'; } ?></td>
				          </tr>
				          ...
				          <tr style="border: 1px solid #cccccc;" id="item_ajax">
				          	<td style="border-right: 1px solid #cccccc;">
				          		...
				          		<input type="text" id="item_code3" name="item_code3" class="form-control" onchange="loadHTMLPost2('app/stock_opname_ajax.php','item_ajax','getdata_code','item_code3')" autofocus="" onKeyPress="return focusNext('qty',event)" value="">
				          	</td>
							...
							<td align="left" style="border-right: 1px solid #cccccc;">
								<input type="text" id="qty" name="qty" style="text-align: right; width: 100px" class="form-control" onkeyup="formatangka('qty')" autocomplete="off" value="" >
							</td>
