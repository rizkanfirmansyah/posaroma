...
?>		
		<td style="border-right: 1px solid #cccccc;">
			<input type="hidden" id="item_code" name="item_code" data-placeholder="..." class="form-control chzn-select-deselect" value="<?php echo $data->syscode ?>">
      		...
      		<input type="text" id="item_code3" name="item_code3" data-placeholder="..." class="form-control chzn-select-deselect" onchange="loadHTMLPost2('app/stock_opname_ajax.php','item_ajax','getdata_code','item_code3')" onKeyPress="return focusNext('qty',event)" value="<?php echo $data->code ?>">
      	</td>
...
?>		
		<td style="border-right: 1px solid #cccccc;">
			<input type="hidden" id="item_code" name="item_code" class="form-control" value="<?php echo $data->syscode ?>">
      		...
      		<input type="text" id="item_code3" name="item_code3" class="form-control" onchange="loadHTMLPost2('app/stock_opname_ajax.php','item_ajax','getdata_code','item_code3')" onKeyPress="return focusNext('qty',event)" value="<?php echo $data->code ?>">
      	</td>
