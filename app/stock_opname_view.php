<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('stock_opname_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_stock_opname($_REQUEST['id']);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('stock_opname_view') ?>" />
			<?php
				...
				<div class="col-xs-12">
					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$select->list_stock_opname("", $from_date, $to_date, $all);
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmstock_opname_pos')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('stock_opname_list') ?>&search=<?php echo $row_stock_opname->syscode ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmstock_opname_pos')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $row_stock_opname->syscode ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
