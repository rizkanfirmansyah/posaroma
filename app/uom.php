	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" action="" method="post" name="uom" id="uom" enctype="multipart/form-data" onSubmit="return cekinput('code,name');" >
            	...
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">UoM Name *)</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="active" id="active" value="1" <?php if($row_uom->active==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
					</div>
				</div><!-- /.row -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="uid" name="uid" readonly class="form-control" value="<?php echo $row_uom->uid ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dlu" name="dlu" readonly class="form-control" value="<?php echo $row_uom->dlu ?>" >
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . obraxabrix(uom_view) ?>'" />
