<?php
	...
	//$urlloc = 'http://localhost/aromapos/app/uploader/uploader_pos.php';
	$urlloc = 'http://pos.erparoma.com/app/uploader/uploader_pos.php'; //online
	
	/*===========start upload */
	//$ch = curl_init("http://localhost/aromapos/app/uploader/create_pos.php?whs=$location_id"); //localhost only
	$ch = curl_init("http://localhost/aromapos/app/uploader/create_pos.php?whs=$location_id"); //localhost only
	curl_exec($ch);
	...
	$ch = curl_init("http://pos.erparoma.com/app/uploader/process_upload_pos.php?whs=$location_id"); //online
	curl_exec($ch);
	
	
	//$ch = curl_init("http://localhost/tokosahabat/app/uploader/process_upload_sales_detail.php?whs=$location_id"); //localhost
	$ch = curl_init("http://pos.erparoma.com/app/uploader/process_upload_pos_detail.php?whs=$location_id"); //online
	curl_exec($ch);
