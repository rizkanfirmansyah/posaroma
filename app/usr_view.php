	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('usr_view') ?>" />
			<?php
				}
			?>
								...
								?>
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <a href="main.php?menu=app&act=<?php echo obraxabrix('usr') ?>&search=<?php echo $usr_view->id ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													<span class="green">
