	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='code') {
			alert('Warehouse Code cannot empty!');				
		  }
		  
		  if (document.getElementById(arrf[i]).name=='name') {
			alert('Warehouse cannot empty!');				
		  }
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="warehouse" id="warehouse" enctype="multipart/form-data" onSubmit="return cekinput('code,name');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="code" name="code" class="form-control" value="<?php echo $row_warehouse->code ?>">
					</div>
				</div>
				
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Warehouse *)</label>
					<div class="col-sm-3">
						<input type="text" id="name" name="name" class="form-control" value="<?php echo $row_warehouse->name ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="active" id="active" value="1" <?php if($row_warehouse->active==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
					</div>
				</div><!-- /.row -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="uid" name="uid" readonly class="form-control" value="<?php echo $row_warehouse->uid ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dlu" name="dlu" readonly class="form-control" value="<?php echo $row_warehouse->dlu ?>" >
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmwarehouse_pos')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmwarehouse_pos')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Save" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmwarehouse_pos')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . obraxabrix(warehouse_view) ?>'" />
